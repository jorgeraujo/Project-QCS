 ...
 * and types representing the binding of schema
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived types for package: client
     * 
     */
